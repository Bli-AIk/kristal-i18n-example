local OPTIONAL_LIBRARY_ENV = "KRISTAL_I18N_EXAMPLE_OPTIONAL_LIBS"
...
-- Launch-time override, e.g. KRISTAL_I18N_EXAMPLE_OPTIONAL_LIBS="mgr,umr" or "mgr,-umr".
...
local function applyOptionalLibraryOverride(info, selection)
    ...
    table.sort(applied)
    print("[kristal-i18n-example] " .. OPTIONAL_LIBRARY_ENV .. '="' .. spec .. '" -> ' ..
