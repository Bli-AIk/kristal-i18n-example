...
"""
    replacement = """    def signingKeystore = System.getenv("KRISTAL_I18N_EXAMPLE_ANDROID_SIGNING_KEYSTORE")
    def hasCustomSigning = signingKeystore != null && !signingKeystore.isEmpty()
    def signingStorePassword = System.getenv("KRISTAL_I18N_EXAMPLE_ANDROID_SIGNING_STORE_PASSWORD")
    def signingKeyAlias = System.getenv("KRISTAL_I18N_EXAMPLE_ANDROID_SIGNING_KEY_ALIAS")
    def signingKeyPassword = System.getenv("KRISTAL_I18N_EXAMPLE_ANDROID_SIGNING_KEY_PASSWORD")
